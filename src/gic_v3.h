...
#define REG_GIC_GICC_CTLR          ((volatile unsigned int *)GIC_GICC_CTLR)
#define REG_GIC_GICC_PMR           ((volatile unsigned int *)GIC_GICC_PMR)
#define REG_GIC_GICC_BPR           ((volatile unsigned int *)GIC_GICC_BPR)
#define REG_GIC_GICC_IAR           ((volatile unsigned int *)GIC_GICC_IAR)
#define REG_GIC_GICC_EOIR          ((volatile unsigned int *)GIC_GICC_EOIR)
#define REG_GIC_GICC_RPR           ((volatile unsigned int *)GIC_GICC_RPR)
#define REG_GIC_GICC_HPIR          ((volatile unsigned int *)GIC_GICC_HPIR)
#define REG_GIC_GICC_ABPR          ((volatile unsigned int *)GIC_GICC_ABPR)
#define REG_GIC_GICC_IIDR          ((volatile unsigned int *)GIC_GICC_IIDR)

/* Register access macros for GICD */
#define REG_GIC_GICD_CTLR             ((volatile unsigned int *)GIC_GICD_CTLR)
#define REG_GIC_GICD_TYPE             ((volatile unsigned int *)GIC_GICD_TYPE)
#define REG_GIC_GICD_IIDR             ((volatile unsigned int *)GIC_GICD_IIDR)
#define REG_GIC_GICD_IGROUPR(n)       ((volatile unsigned int *)GIC_GICD_IGROUPR(n))
#define REG_GIC_GICD_ISENABLER(n)     ((volatile unsigned int *)GIC_GICD_ISENABLER(n))
#define REG_GIC_GICD_ICENABLER(n)     ((volatile unsigned int *)GIC_GICD_ICENABLER(n))
#define REG_GIC_GICD_ISPENDR(n)       ((volatile unsigned int *)GIC_GICD_ISPENDR(n))
#define REG_GIC_GICD_ICPENDR(n)       ((volatile unsigned int *)GIC_GICD_ICPENDR(n))
#define REG_GIC_GICD_ISACTIVER(n)     ((volatile unsigned int *)GIC_GICD_ISACTIVER(n))
#define REG_GIC_GICD_ICACTIVER(n)     ((volatile unsigned int *)GIC_GICD_ICACTIVER(n))
#define REG_GIC_GICD_IPRIORITYR(n)    ((volatile unsigned int *)GIC_GICD_IPRIORITYR(n))
#define REG_GIC_GICD_ITARGETSR(n)     ((volatile unsigned int *)GIC_GICD_ITARGETSR(n))
#define REG_GIC_GICD_ICFGR(n)         ((volatile unsigned int *)GIC_GICD_ICFGR(n))
#define REG_GIC_GICD_NSCAR(n)         ((volatile unsigned int *)GIC_GICD_NSCAR(n))
#define REG_GIC_GICD_SGIR             ((volatile unsigned int *)GIC_GICD_SGIR)
#define REG_GIC_GICD_CPENDSGIR(n)     ((volatile unsigned int *)GIC_GICD_CPENDSGIR(n))
#define REG_GIC_GICD_SPENDSGIR(n)     ((volatile unsigned int *)GIC_GICD_SPENDSGIR(n))
