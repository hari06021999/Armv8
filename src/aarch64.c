...
*/
unsigned long long raw_read_rvbar_el1(void)
{
	unsigned long long rvbar_el1;

	__asm__ __volatile__("mrs %0, RVBAR_EL1\n\t" : "=r" (rvbar_el1) :  : "memory");
	return rvbar_el1;
}

void raw_write_rvbar_el1(unsigned long long rvbar_el1)
{
...
*/
unsigned long long raw_read_vbar_el1(void)
{
...
void raw_write_vbar_el1(unsigned long long vbar_el1)
{
...
*/
unsigned long long raw_read_cntvct_el0(void)
{
	unsigned long long cntvct_el0;
...
*/
unsigned long long raw_read_cntv_cval_el0(void)
{
	unsigned long long cntv_cval_el0;

	__asm__ __volatile__("mrs %0, CNTV_CVAL_EL0\n\t" : "=r" (cntv_cval_el0) : : "memory");
	return cntv_cval_el0;
}

void raw_write_cntv_cval_el0(unsigned long long cntv_cval_el0)
{
